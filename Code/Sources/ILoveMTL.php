  ...
  class ILoveMTL {
    ...
    public function GetDivisionData($SRID, $URL, $LID, $TZ, $Sub = false, $WebD = false) {
      ...
      if ($WebD) {
        ...
        $NewDeal = array (
          "ID" => array('', 'og:url', 'content="http://www.ilovemtl.ca/en/escapes/', '"', false),
          "Title" => array('', 'og:title', 'content="', '"', false),
          "PriceSale" => array(0, 'id="escape-promo-price"', '<span>', '$', true),
          "PriceReg" => array(0, 'id="escape-promo-regprice"', ':', '$', true),
          "StoreName" => array('', 'class="location-name', '>', '<', false),
          "Description" => array('', 'line-height:1.45em;', '>', '<!-- Fine print -->', false),
        ...
        $NewDeal = array (
          ...
          "EndDate" => array('', 'var endtime =', 'new Date(', ')', false),
          "Address" => array('', 'class="location-addr"', '>', '<a', false, true),
          "Website" => array('', 'class="location-addr"', '<a href="', '"', false, true)
        );
